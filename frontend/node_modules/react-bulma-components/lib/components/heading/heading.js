...
Heading.propTypes = _objectSpread({}, _modifiers["default"].propTypes, {
  children: _propTypes["default"].node,
  className: _propTypes["default"].string,
  renderAs: _renderAs["default"],
  size: _propTypes["default"].oneOf([1, 2, 3, 4, 5, 6]),
  weight: _propTypes["default"].oneOf(['light', 'normal', 'semibold', 'bold']),
  subtitle: _propTypes["default"].bool,
  heading: _propTypes["default"].bool,
  spaced: _propTypes["default"].bool
});
Heading.defaultProps = _objectSpread({}, _modifiers["default"].defaultProps, {
  children: null,
  className: undefined,
  renderAs: 'h1',
  size: undefined,
