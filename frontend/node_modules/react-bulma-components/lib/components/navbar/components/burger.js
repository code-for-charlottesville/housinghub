...
var NavbarBurger = function NavbarBurger(_ref) {
  ...
  return _react["default"].createElement(_context.ShowContext.Consumer, null, function (active) {
    ...
    }, props), _react["default"].createElement("span", null), _react["default"].createElement("span", null), _react["default"].createElement("span", null));
  });
};

NavbarBurger.propTypes = _objectSpread({}, _modifiers["default"].propTypes, {
  style: _propTypes["default"].shape({}),
  className: _propTypes["default"].string,
  onClick: _propTypes["default"].func
});
NavbarBurger.defaultProps = _objectSpread({}, _modifiers["default"].defaultProps, {
  style: undefined,
  className: undefined,
