...
var MediaContent = function MediaContent(_ref) {
  ...
  return _react["default"].createElement(_element["default"], _extends({}, props, {
    className: (0, _classnames["default"])(className, 'content')
  }), children);
};

MediaContent.propTypes = _objectSpread({}, _modifiers["default"].propTypes, {
  children: _propTypes["default"].node,
  className: _propTypes["default"].string,
  style: _propTypes["default"].shape({}),
  renderAs: _renderAs["default"]
});
MediaContent.defaultProps = _objectSpread({}, _modifiers["default"].defaultProps, {
  children: null,
  className: undefined,
  style: undefined,
  renderAs: 'div'
});
var _default = MediaContent;
exports["default"] = _default;
//# sourceMappingURL=media-content.js.map