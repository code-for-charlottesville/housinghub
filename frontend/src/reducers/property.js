  ...
  return {
    ...
    addProperty: {
      fields: {
        ...
        elevator: false,
        date_first_available: new Date(Date.now()).toISOString().slice(0, 10),
        year_available: new Date(Date.now()).getFullYear(),
        potential_month_available: 0,
        listing_date: new Date(Date.now()).toISOString().slice(0, 10),
        where_listed: [],
        contact_method: [],
        last_contact_date: new Date(Date.now()).toISOString().slice(0, 10),
