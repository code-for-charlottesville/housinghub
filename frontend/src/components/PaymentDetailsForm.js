    ...
    <div className="box">
          ...
          <div className="field">
            ...
            <div className="select">
              <select id="lastMonthBool" onChange={e => 
          ...
          <div className="field">
            ...
            <label className="checkbox">
              <input type="checkbox" onChange={e => 
                props.dispatch(setPropertyField("CSRAP", e.target.value === "true"))
                }
            ...
            <label className="checkbox">
              <input type="checkbox" onChange={e => 
                props.dispatch(setPropertyField("HCV", e.target.value === "true"))
                }
            ...
            <label className="checkbox">
              <input type="checkbox" onChange={e => 
                props.dispatch(setPropertyField("MSV", e.target.value === "true"))
                }
            ...
            <label className="checkbox">
              <input type="checkbox" onChange={e => 
                props.dispatch(setPropertyField("voucher4", e.target.value === "true"))
                }
            ...
            <label className="checkbox">
              <input type="checkbox" onChange={e => 
                props.dispatch(setPropertyField("voucher5", e.target.value === "true"))
                }
          ...
          <div className="field">
            ...
            <div className="select">
              <select id="backgroundBool" onChange={e => 
