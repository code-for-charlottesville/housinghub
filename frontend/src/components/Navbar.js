    ...
    <Navbar expand="lg" bg="dark" variant="dark" className="container-fluid">
      ...
      <Navbar.Collapse id="responsive-navbar-nav">
        <Nav className="flex-lg-fill">
          <Nav.Link>
            <Link to="/property/search" className="h-hub-nav-link" title="Search property database">Search</Link>
          </Nav.Link>
          <Nav.Link>
            <Link to="/property/manage" className="h-hub-nav-link" title="Manage properties">My Houses</Link>
          </Nav.Link>
          <Nav.Link>
            <Link to="/about" className="h-hub-nav-link" title="Learn more about Code-For-Charlottesville!">About</Link>
          </Nav.Link>
          <Nav.Link>
